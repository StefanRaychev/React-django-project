...
const response = await axios.put('/lector/profile/', formData, {
  headers: {
    ...
    const refreshedUser = await axios.get('/lector/profile/', {
  ...
  const handleDelete = () => {
    window.location.href = '/lector/delete-profile';
  };
...
export default LectorProfileEdit;
