...
console.log("🧠 LOADED: LectorLoginPage.js in use");

const LectorLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('/lector/login/', formData);
  ...
  return (
    <div className="login-container">
      <div className="login-box">
        <h2 className="login-title">LECTOR LOGIN</h2>
...
export default LectorLoginPage;
